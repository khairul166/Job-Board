        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="profile-section position-relative">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <button class="btn btn-sm btn-outline-success edit-section-btn" data-bs-toggle="modal" data-bs-target="#editAboutModal">
                ...
                <div class="profile-section position-relative personalinfo-section">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <button class="btn btn-sm btn-outline-success edit-section-btn" data-bs-toggle="modal" data-bs-target="#editPersonalInfoModal">
                            <i class="fas fa-edit"></i>
                        </button>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="mb-4">
                                ...
                                <p><?php echo esc_html($presentaddressline); ?></p>
                            </div>
                            <div class="mb-4">
                                <h5>Permanent address</h5>
                                <p><?php echo esc_html($permanentaddressline); ?></p>
                            </div>
                            <div class="mb-4">
                ...
                <div class="profile-section position-relative education-section">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <button class="btn btn-sm btn-outline-success" data-bs-toggle="modal" data-bs-target="#editEducationModal">
                    ...
                    <?php if (!empty($education_entries)) : ?>
                        <?php foreach ($education_entries as $entry) : ?>
                            ...
                            $result_text = '';
                            if (
                                !empty($entry['result_type']) && !empty($entry['gpa']) &&
                ...
                <div class="profile-section position-relative training-section">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <button class="btn btn-sm btn-outline-success" data-bs-toggle="modal" data-bs-target="#editTrainingModal">
                            ...
                            <div class="mb-4 border-bottom pb-3 d-flex justify-content-between align-items-start training-item" data-id="<?php echo $entry_id; ?>">
                                <div>
                                    ...
                                    <p class="text-muted mb-1">
                                        ...
                                        <span class="start-year"><?php echo $start_date_display; ?></span> - <span class="end-year"><?php echo $end_date_display; ?></span>
                                        <?php if ($duration): ?>
                                            • <?php echo $duration; ?>
                                        <?php endif; ?>
                                    </p>
                ...
                <div class="profile-section position-relative experiance-section">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <button class="btn btn-sm btn-outline-success edit-section-btn" data-bs-toggle="modal" data-bs-target="#workExperienceModal">
                            <i class="fa-solid fa-plus"></i> Add
                        </button>
                    </div>
                ...
                <div class="profile-section position-relative reference-section">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <button class="btn btn-sm btn-outline-success edit-section-btn" data-bs-toggle="modal" data-bs-target="#referenceModal">
                            <i class="fa-solid fa-plus"></i> Add
                        </button>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <div class="profile-section">
                    ...
                    <button class="btn btn-sm btn-success mt-3" data-bs-toggle="modal" data-bs-target="#addSkillsModal">+ Add Skills</button>
                </div>
                ...
                <div class="profile-section">
                    ...
                    <button class="btn btn-sm btn-success mt-3" data-bs-toggle="modal" data-bs-target="#addlangguageModal">+ Add Language</button>
                </div>
                ...
                <div class="profile-section resume-section">
                    ...
                    <?php if (!empty($resume_file)) : ?>
                        ...
                        <div class="d-grid gap-2 resume-actions">
                            <a href="<?php echo esc_url($resume_file); ?>" class="btn btn-outline-success" download><i class="fas fa-download me-1"></i> Download</a>
                    ...
                    <form id="personalInfoForm">
                        ...
                        <div class="row">
                            ...
                            <div class="bg-light p-3">
                                <h6 class="pb-2">Present Address</h6>
                                <div class="row">
                                    <div class="col-sm-6 mb-3">
                                        <label class="form-label">Address Line</label>
                                        <textarea class="form-control" name="presentaddressline" rows="2"><?php echo esc_textarea($present_address); ?></textarea>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mt-3">
                                        <label for="presentpostcode" class="form-label">Post Code</label>
                                        <input type="text" class="form-control" name="presentpostcode" id="presentpostcode" value="<?php echo esc_attr($present_postcode); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="mt-3 p-3" id="permanentAddressSection">
                                <h6 class="pb-2">Permanent Address</h6>
                                <div class="row mb-2">
                                    <div class="col-12">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="sameAsPresent" name="sameAsPresent">
                                ...
                                <div class="row" id="permanentAddressFields">
                                    <div class="col-sm-6 mb-3">
                                        <label class="form-label">Address Line</label>
                                        <textarea class="form-control" name="permanentaddressline" rows="2"><?php echo esc_textarea($permanent_address); ?></textarea>
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                        <label for="permanent_division" class="form-label">Permanent Division</label>
                                        <select id="permanent_division" name="permanent_division" class="form-select">
                                            <option value="">Select Division</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <label for="permanent_upazila" class="form-label">Permanent Upazila / Thana</label>
                                        <select id="permanent_upazila" name="permanent_upazila" class="form-select">
                                            <option value="">Select Upazila/Thana</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                        <label for="permanent_postcode" class="form-label">Post Code</label>
                                        <input type="text" class="form-control" name="permanent_postcode" id="permanent_postcode" value="<?php echo esc_attr($permanent_postcode); ?>">
                                    </div>
                                    <div class="col-sm-6 mb-3">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" id="saveWorkExperience">Save</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="addSkillsModal" tabindex="-1" aria-labelledby="addSkillsModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-success" id="saveSkills">Save Skills</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="addlangguageModal" tabindex="-1" aria-labelledby="addlangguageModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-success" id="saveLangguage">Save Language</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="referenceModal" tabindex="-1" aria-labelledby="referenceModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-success" id="saveReference">Save Reference</button>
                </div>
            </div>
        </div>
    </div>

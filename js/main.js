...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('resumeUploadForm').addEventListener('submit', function(e) {
        ...
        setTimeout(() => {
            ...
            const modal = bootstrap.Modal.getInstance(document.getElementById('resumeUploadModal'));
            modal.hide();
        }, 2000);
    });
    
    // Handle resume removal using event delegation
    document.addEventListener('click', function(e) {
        // // Check if the clicked element is the remove button
        // if (e.target.closest('.btn-outline-danger') && e.target.closest('.profile-section')) {
        ...
        if (e.target.closest('.btn-outline-primary') && e.target.closest('.resume-section')) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('floatingConfirmPassword').addEventListener('input', function(e) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('aboutMeForm').addEventListener('submit', function (e) {
        e.preventDefault();
        const updatedText = document.getElementById('aboutMeTextarea').value;
        document.querySelector('.profile-section p').innerText = updatedText;

...
function ajax_download_cv() {
    ...
    require_once get_template_directory() . '/inc/dompdf/autoload.inc.php'; // Update this path to where you installed DomPDF
    ...
    $options->set('isRemoteEnabled', true); // Enable remote files for images
    ...
    $upload_dir = wp_upload_dir();
    $filename = 'CV_' . sanitize_file_name($application->full_name) . '_' . date('Y-m-d') . '.pdf';
    $file_path = $upload_dir['path'] . '/' . $filename;
...
<head>
    ...
    <style>
        ...
        .hero-section {
            background: linear-gradient(135deg, var(--green-color), #DCFBDB);
            padding: 4rem 0;
            margin-bottom: 2rem;
        }
        ...
        .job-listing {
            position: relative;
            /* Ensures that child elements are positioned relative to this parent */
            padding: 10px;
        ...
        .featured-badge {
            position: absolute;
            /* Positions the badge independently */
            top: 10px;
            /* Adjust top position as necessary */
            right: 10px;
            /* Adjust right position as necessary */
        ...
        .salary-text {
            clear: both;
            /* Ensures the salary text does not overlap with floated elements */
            margin-top: 20px;
            /* Adds space above the salary */
            font-size: 18px;
            /* Ensures font size is appropriate */
        }
        ...
        .job-header {
            background: linear-gradient(-135deg, var(--green-color), #37A346);
            color: white;
            padding: 3rem 0;
            margin-bottom: 2rem;
        }
        ...
        /* Make dropdown appear on hover for desktop */
        @media (min-width: 992px) {
        ...
        footer .input-group .btn-success:hover {
            background-color: #157347;
            border-color: #146c43;
        }
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-7">
                    <div class="header-content">
                        <h1 class="mb-3 text-white"><?php echo esc_html($full_name); ?></h1> 

        ...
        <div class="login-container">
            ...
            <form>
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <a href="#" class="text-success-link">Forgot password?</a>
                </div>
                
                <button class="btn btn-login btn-success" type="submit">Login</button>
                
                <div class="additional-links">
                    <p class="text-muted">Don't have an account? <a href="#" class="text-success-link">Sign up</a></p>
                    <hr>

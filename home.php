    ...
    <div class="container">
        <div class="row align-items-center"> <!-- This line updated -->
            ...
            <div class="col-md-8">
                ...
                <a href="<?php echo esc_url(home_url('/job-listing')); ?>" class="btn btn-success">View All Jobs</a>
            </div>
        </div>
    </div>
</section>
...
// Get today's date in the same format your meta saves (Y-m-d)
...
<section class="hero-section" style="margin-bottom: 0px;">
    <h1 class="text-center py-4"><?php _e('Recent Active Jobs', 'job-listing'); ?></h1>
    ...
    <div class="container">
            ...
            <div class="col-lg-12">
                <?php if ($recent_jobs->have_posts()){ ?>
                    ...
                    <div class="text-center">
                        <a href="<?php echo esc_url(home_url('/job-listing')); ?>" class="btn btn-success">
        ...
        <?php
                    ...
                    echo '<p class="text-center">' . __('No active jobs found.', 'job-listing') . '</p>';
                }
                wp_reset_postdata();
        ?>
        </div>
